...
# ---- Load TFLite Model ----
interpreter = tf.lite.Interpreter(model_path= r"D:\\4th semester GIKI\\CS-232 (DBMS)\\Project\\DBMSPROJECT\\AI-Based-Medicine-Recognition-and-Sorting-Tool\\version 1.0\\model_unquant.tflite")
...
# ---- Load Labels ----
with open("D:\\4th semester GIKI\\CS-232 (DBMS)\\Project\\DBMSPROJECT\\AI-Based-Medicine-Recognition-and-Sorting-Tool\\version 1.0\\labels.txt", "r") as f:
